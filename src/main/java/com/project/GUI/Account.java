...
public class Account extends javax.swing.JPanel {
    ...
    public Account() {
        initComponents();
        ArrayList<AccountDTO> listAccount =AccountBUS.getAllAccount();
        ...
        int selectedRow = TK_Table.getSelectedRow();
                if (selectedRow != -1) {
                        try {
                                ...
                                String email = (String) TK_Table.getValueAt(selectedRow, 1);
                                String quyen = (String) TK_Table.getValueAt(selectedRow, 2);

                                AccountDTO update_supplier = new AccountDTO(id, email, quyen,  null, null);

                                new FormUpDateAccount(update_supplier).setVisible(true);
