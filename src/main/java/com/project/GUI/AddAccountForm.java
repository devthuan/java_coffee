...
public class AddAccountForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BoxPhone.add(jPasswordField1, java.awt.BorderLayout.CENTER);
        ...
        Email.setText("Nhập lại mật khẩu");
        ...
        BoxEmail.add(jPasswordField2, java.awt.BorderLayout.CENTER);
    ...
    private void BtnAddMouseClicked(java.awt.event.MouseEvent evt) {
        String email = InputName.getText();
        int role_id = jComboBox1.getSelectedIndex();

        char[] password1Char = jPasswordField1.getPassword();
        char[] password2Char = jPasswordField2.getPassword();
    ...
    private void BtnAddKeyTyped(java.awt.event.KeyEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAccountForm.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
